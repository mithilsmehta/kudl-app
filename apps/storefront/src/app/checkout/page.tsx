...
export default function CheckoutPage() {
  ...
  const isFreeDelivery =
    !!appliedCoupon && shippingTotal === 0 && selectedShippingAmount > 0
  ...
  if (step === 3 && placedOrder) {
    return (
      <div className="mx-auto flex max-w-md flex-col items-center px-6 py-16 text-center">
        ...
        <h1 className="mt-5 text-2xl font-bold text-kudl-ink">
        ...
        <div className="mt-6 w-full rounded-kudl-card border border-kudl-border bg-white p-4 text-left">
          ...
          <p className="mt-2 text-[13px] text-kudl-subtle">
            Status: {placedOrder.status.toUpperCase()}
          </p>
          <p className="mt-1 text-[13px] text-kudl-subtle">
            Total:{" "}
            {formatCurrency(placedOrder.total, placedOrder.currency_code)}
          </p>
        </div>
  ...
  const stepClass = (n: 1 | 2) =>
    step === n
      ? "border-kudl-primary text-kudl-primary"
      : "border-transparent text-kudl-faint"
    ...
    <div>
      ...
      <div className="border-b border-kudl-border bg-white">
        <div className="mx-auto flex max-w-3xl gap-6 px-4 md:px-6">
          <span
            className={`flex items-center gap-2 border-b-2 py-3 text-sm font-semibold ${stepClass(1)}`}
          >
            <MapPin className="h-4 w-4" aria-hidden="true" />
            1. Address
          </span>
          <span
            className={`flex items-center gap-2 border-b-2 py-3 text-sm font-semibold ${stepClass(2)}`}
          >
      ...
      <div className="mx-auto max-w-3xl p-4 md:px-6 md:pb-16">
        ...
        {step === 1 ? (
          showAddressForm ? (
            ...
            <div className="mt-3">
              <h2 className="mb-3 text-base font-bold text-kudl-ink">
          ...
          <div className="mt-3">
            ...
            {appliedCoupon ? (
              <div className="flex items-center gap-3 rounded-kudl-card border border-emerald-200 bg-emerald-50 p-4">
                ...
                <span className="min-w-0 flex-1">
                  <span className="block text-sm font-bold text-kudl-ink">
                    {appliedCoupon}
                  </span>
                  <span className="block text-[13px] text-kudl-muted">
                    {discountTotal > 0
            ...
            >
              ...
              <span className="flex-1">
                <span className="block text-[13px] font-bold text-kudl-primary">
                  View all coupons
                </span>
            ...
            */}
              ...
              <div className="mb-2 flex justify-between">
                ...
                {shippingUpdating ? (
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold text-kudl-success">
                      FREE
                    </span>
                  </span>
                ) : (
            ...
            >
              {isLoading ? (
                <Spinner className="h-5 w-5 text-white" label="Placing order" />
              ) : (
